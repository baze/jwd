...
if ($url != 'https://jwdsign.de') {

	add_action( 'admin_menu', 'brainbox_validation_register' );

	function brainbox_validation_render(){

	    print '<div class="wrap">';
	    	print "<h1>Ihre BrainBox-Lizenz</h1>";

	    	require get_template_directory() . '/inc/license-validation.php';

	    print '</div>';
	}

	function brainbox_validation_register(){
	    add_menu_page(
	        'Ihre BrainBox-Lizenz',
	        'BrainBox-Lizenz',
	        'manage_options',
	        'brainbox-lizenz',
	        'brainbox_validation_render'
	    );
	}
	...
	if ( is_admin() && 'themes.php' == $pagenow && isset( $_GET['activated'] ) ) {
	        ...
	        wp_redirect(admin_url("admin.php?page=brainbox-lizenz")); // Your admin page URL
